...
import {getAllNfbChecklistItems} from "../services/checklistNonFB";
...
class New extends Component {
      ...
      noncompliances: [
        {
          ...
          value: [
            ...
            { resolved: false },
            ["hello there", ["data:image/png;base64,"], "tenant"],
          ],
        },
  ...
  checkSame(value) {
    console.log("NON COMPLAINCES: ", this.state.noncompliances);
    this.state.noncompliances.map((index) => console.log("INDEX: ", index)); //this is the value //where we append the tenant array
    //this.state.noncompliances.map((value, index) => console.log(value.key)); //this is they key
    this.state.noncompliances.map((value) => console.log("VALUE: ", value)); //this is the value //where we append the tenant array
    this.state.noncompliances.map((index) => console.log("INDEX KEY: ", index.key)); //this is the value //where we append the tenant array
